...
function ajaxBefore()
{
  $('#fields-holder, #editor-sidebar-form-holder').find('a, button').addClass('easyorder-disabled');
  ajaxIsActive = true;
}
...
function ajaxAfter(response)
{
  ...
  $('.loader').hide();
  ajaxIsActive = false;
  $('#fields-holder, #editor-sidebar-form-holder').find('a, button').removeClass('easyorder-disabled');
}
