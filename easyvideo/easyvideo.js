...
loadScriptEasyVideo("//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js", function(){
    ...
    function easyVideoSetup() {
      ...
      ev$("#product-images .owl-item div img[alt*='youtube.com/watch'], #mob-product-images .owl-item div img[alt*='youtube.com/watch").each(function(){
      ...
      ev$("#product-images .owl-item div img[alt*='youtu.be/'], #mob-product-images .owl-item div img[alt*='youtu.be/']").each(function(){
        var video_link = ev$(this).prop("alt");
      ...
      ev$("#product-images .owl-item div img[alt*='//vimeo.com/'], #mob-product-images .owl-item div img[alt*='//vimeo.com/']").each(function(){
        var video_link = ev$(this).prop("alt");
